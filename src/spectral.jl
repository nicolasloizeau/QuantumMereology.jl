...
function cost_spectral(h::Vector{<:Number}, strings::Vector{<:Union{SparseMatrixCSC, PauliString}}, E0::Vector{<:Number})
    H = buildH(h, strings)
...
function gradient_spectral(h::Vector{<:Number}, strings::Vector{<:Union{SparseMatrixCSC, PauliString}}, E0::Vector{<:Number})
